...
PREFIX=/data_from_the_preprint/PacBio_HG001_training_data_set
...
BAM_FILE=$PREFIX/na12878_pacbio_mts_ngmlr-0.2.3_mapped.rg.bam
BAM_IDX=$PREFIX/na12878_pacbio_mts_ngmlr-0.2.3_mapped.rg.bam.bai
